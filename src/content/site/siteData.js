const personalInfo = {
  description: [
    ...
    `I have an interest in systems, performance optimization and machine learning.
      ...
      and Deep Learning.`,
    'Some of the most exciting projects I\'ve worked on include contributing to the [Triton](https://github.com/openai/triton "A ML compiler for deep learning") language and compiler for GPU programming, and enhancing [Firefox](https://www.mozilla.org/en-US/firefox/ "A free and open-source web browser developed by Mozilla") Privacy at Mozilla.',
  ],
