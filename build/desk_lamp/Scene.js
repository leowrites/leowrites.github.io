    ...
    <group ref={group} {...props} dispose={null}>
      <group rotation={[-Math.PI / 2, 0, 0]} scale={0.06}>
        <group rotation={[Math.PI / 2, 0, 0]}>
          ...
          <group position={[-13.34, 26.48, 0]} rotation={[-Math.PI, 0, -1.83]}>
          ...
          <group position={[-14.05, 26.07, 0]} rotation={[-Math.PI, 0, -1.83]}>
            <group position={[0.09, 1.04, -1]}>
              <mesh
          ...
          <group position={[-13.49, 26.56, 0]} rotation={[-Math.PI, 0, -1.83]}>
            <group position={[0.09, 1.04, -1]}>
              <mesh
          ...
          <group position={[2.42, 37.55, -4.68]} rotation={[Math.PI, 0, -2.79]}>
            <mesh
          ...
          <group position={[1.88, 36.06, 1.64]} rotation={[-Math.PI / 2, 0, 0]}>
            <mesh
